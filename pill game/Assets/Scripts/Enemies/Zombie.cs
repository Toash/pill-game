...
public class Zombie : Enemy
{
    ...
    protected override void Die()
    {
        ...
        ParticleManager.PlayParticleAtPosition(ParticleManager.instance.EnemyDeathFX,this.transform);
        ParticleManager.PlayParticleAtPosition(ParticleManager.instance.BloodMistFX,this.transform);
